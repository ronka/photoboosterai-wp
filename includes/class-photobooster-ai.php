...
class Photobooster_Ai
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Photobooster_Ai_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'photobooster-ai';
	 ...
	 *
	 * - Photobooster_Ai_Loader. Orchestrates the hooks of the plugin.
	 * - Photobooster_Ai_i18n. Defines internationalization functionality.
	 * - Photobooster_Ai_Admin. Defines all hooks for the admin area.
	 * - Photobooster_Ai_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Photobooster_Ai_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
